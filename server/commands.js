...
const commands = [
	...
	{ name: "login",	level: 0, cost: 0, flags: ALLOW_ALL, 		arguments: "is", 	function: function(client,params) { Player.get(client).passwordLogin(params);} },
	{ name: "register", level: 0, cost: 0, flags: ALLOW_ALL, 		arguments: "is", 	function: function(client,params) { Player.get(client).register(params);} },
	{ name: "stats",	level: 0, cost: 0, flags: ALLOW_ALL, 		arguments: "", 		function: function(client,params) { printStats(client,params);} },
	{ name: "top",		level: 0, cost: 0, flags: ALLOW_ALL, 		arguments: "",		function: function(client,params) { printTop(client, params) } },
	...
	{ name: "rawstats",	level: 0, cost: 0, flags: ALLOW_ALL, 		arguments: "", 		function: function(client,params) { printRawStats(client,params);} },
	{ name: "achievements",	level: 0, cost: 0, flags: ALLOW_ALL, 		arguments: "", 		function: function(client,params) { printAchievements(client,params);} },
	{ name: "flighttime",	level: 0, cost: 0, flags: ALLOW_ALL, 		arguments: "", 		function: function(client,params) { printFlightTime(client,params);} },
	{ name: "quest",	level: 0, cost: 0, flags: ALLOW_ALL, 		arguments: "",		function: function(client,params) { Quest.print(client, params) } },
	...
	// Misc commands
	{ name: "cd",		level: 0, cost: 10, flags: ALLOW_ALL, 		arguments: "", 		function: function(client,params) { countdown(client);} },
	{ name: "anim",		level: 0, cost: 0, flags: ALLOW_ON_FOOT, 	arguments: "i", 	function: function(client,params) { setAnim(client, Number(params), 1000); } },
	{ name: "use",		level: 0, cost: 0, flags: ALLOW_ON_FOOT, 	arguments: "", 		function: function(client,params) { Player.get(client).useItem(params); } },
	{ name: "backpack",	level: 0, cost: 0, flags: ALLOW_ALL, 		arguments: "", 		function: function(client,params) { Player.get(client).backpack.getItems(client); } },
	{ name: "loc",		level: 0, cost: 0, flags: ALLOW_ALL, 		arguments: "", 		function: function(client,params) { locPlayer(client, params); } },
	
	// Help commands
	{ name: "help",		level: 0, cost: 0, flags: ALLOW_ALL, 		arguments: "", 		function: function(client,params) { commandHelp(client, params); } },
    { name: "info",		level: 0, cost: 0, flags: ALLOW_ALL, 		arguments: "", 		function: function(client,params) { infoCommand(client, params); } },
	{ name: "command",	level: 0, cost: 0, flags: ALLOW_ALL, 		arguments: "s", 	function: function(client,params) { commandHelp(client, params); } },
	{ name: "cmds",		level: 0, cost: 0, flags: ALLOW_ALL, 		arguments: "", 		function: function(client,params) { makeList(client, "commands", commands); } },

	// Dojo commands
	{ name: "dojolist",	level: 0, cost: 0, flags: ALLOW_ALL, 		arguments: "", 		function: function(client,params) { makeList(client, "dojos", dojos); } },
	{ name: "dojo",		level: 0, cost: 0, flags: ALLOW_ON_FOOT, 	arguments: "", 		function: function(client,params) { enterDojo(client,params) } },
	{ name: "dojoexit",	level: 0, cost: 0, flags: ALLOW_DOJO, 	    arguments: "", 		function: function(client,params) { exitDojo(client); } },

    // Vehicle commands
    { name: "v",	    level: 0, cost: 50, flags: ALLOW_ON_FOOT,   arguments: "s", 	function: function(client,params) { Vehicle.spawnTempVehicle(client, params); } },
	//{ name: "car",	    level: 0, cost: 0, flags: ALLOW_VEHICLE,   	arguments: "", 		function: function(client,params) { carInfo(client, params); } },
    { name: "col1",	    level: 0, cost: 0, flags: ALLOW_VEHICLE, 	arguments: "i", 	function: function(client,params) { client.player.vehicle.colour1 = Number(params); } },
	{ name: "col2",	    level: 0, cost: 0, flags: ALLOW_VEHICLE, 	arguments: "i", 	function: function(client,params) { client.player.vehicle.colour2 = Number(params); } },
	{ name: "fix",		level: 0, cost: 50, flags: ALLOW_VEHICLE, 	arguments: "", 		function: function(client,params) { client.player.vehicle.fix(); } },
	{ name: "flip",	    level: 0, cost: 50, flags: ALLOW_VEHICLE, 	arguments: "", 		function: function(client,params) { triggerNetworkEvent("flipVehicle", client); } },
	{ name: "taxilight",level: 0, cost: 0, flags: ALLOW_VEHICLE, 	arguments: "", 		function: function(client,params) { triggerNetworkEvent("setTaxiLight", null, client.index, params); } },

	
	// Teleport commands
	{ name: "driveto",	level: 0, cost: 100, flags: ALLOW_VEHICLE, 	arguments: "",		function: function(client,params) { goTo(client,"driveTo",params); } },
	{ name: "walkto",	level: 0, cost: 100, flags: ALLOW_ON_FOOT, 	arguments: "",		function: function(client,params) { goTo(client,"walkTo",params); } },
	{ name: "runto",	level: 0, cost: 100, flags: ALLOW_ON_FOOT, 	arguments: "",		function: function(client,params) { goTo(client,"runTo",params); } },
	{ name: "stop",		level: 0, cost: 100, flags: ALLOW_ALL, 		arguments: "",		function: function(client,params) { goTo(client,"stop",params); } },
	{ name: "goto",		level: 0, cost: 100, flags: ALLOW_ON_FOOT, 	arguments: "",		function: function(client,params) { teleport(client,params); } },
	{ name: "gotolist",	level: 0, cost: 0,	 flags: ALLOW_ALL, 		arguments: "",		function: function(client,params) { makeList(client, "teleports", teleports, true); } },
    { name: "follow",	level: 0, cost: 100, flags: ALLOW_ON_FOOT, 	arguments: "",		function: function(client,params) { goFollow(client, params) } },
    ...
    //-----------------------------------------------------------------------------------------------------------------------------------------
	// Admin commands
	{ name: "storeveh",	level: 5, cost: 0, flags: ALLOW_VEHICLE, 	arguments: "",		function: function(client,params) { saveVehicleSettings(client.player.vehicle); } },
	{ name: "saveall",	level: 5, cost: 0, flags: ALLOW_ALL, 		arguments: "",		function: function(client,params) { saveAllData(client,params); } },
	{ name: "savetele",	level: 5, cost: 0, flags: ALLOW_ON_FOOT, 	arguments: "s",		function: function(client,params) { saveTeleportQuery(client,params); } },
	{ name: "savecar",	level: 5, cost: 0, flags: ALLOW_VEHICLE, 	arguments: "", 		function: function(client,params) { saveVehicleQuery(client); } },
	{ name: "acol1",	level: 1, cost: 0, flags: ALLOW_VEHICLE, 	arguments: "i", 	function: function(client,params) { client.player.vehicle.colour1 = Number(params); } },
	{ name: "acol2",	level: 1, cost: 0, flags: ALLOW_VEHICLE, 	arguments: "i", 	function: function(client,params) { client.player.vehicle.colour2 = Number(params); } },
	...
	{ name: "aflip",	level: 1, cost: 0, flags: ALLOW_VEHICLE, 	arguments: "", 		function: function(client,params) { triggerNetworkEvent("flipVehicle", client); } },
	{ name: "aveh",		level: 1, cost: 0, flags: ALLOW_ON_FOOT, 	arguments: "s", 	function: function(client,params) { Vehicle.spawnTempVehicle(client, params); } },
	{ name: "setweather",level: 1, cost: 0, flags: ALLOW_ALL, 		arguments: "i", 	function: function(client,params) { weather.set(client, params); } },
	{ name: "settime",	level: 1, cost: 0, flags: ALLOW_ALL, 		arguments: "ii", 	function: function(client,params) { setTime(client, params) } },
	{ name: "kick",		level: 2, cost: 0, flags: ALLOW_ALL, 		arguments: "i", 	function: function(client,params) { kick(client, params); } },
	{ name: "ban",		level: 4, cost: 0, flags: ALLOW_ALL, 		arguments: "i", 	function: function(client,params) { ban(client, params); } },
	{ name: "mute",		level: 1, cost: 0, flags: ALLOW_ALL, 		arguments: "i", 	function: function(client,params) { mute(client, params); } },
	{ name: "healall",	level: 1, cost: 0, flags: ALLOW_ALL, 		arguments: "", 		function: function(client,params) { healAll(client, params); } },
	{ name: "freezeall",level: 1, cost: 0, flags: ALLOW_ALL, 		arguments: "", 		function: function(client,params) { setPlayerControls(client, false); } },
	{ name: "unfreezeall",level: 1, cost: 0, flags: ALLOW_ALL, 		arguments: "", 		function: function(client,params) { setPlayerControls(client, true); } },
	{ name: "bringall",	level: 1, cost: 0, flags: ALLOW_ON_FOOT, 	arguments: "", 		function: function(client,params) { bringAll(client, params); } },
	{ name: "bringallveh",	level: 5, cost: 0, flags: ALLOW_ON_FOOT, arguments: "", 		function: function(client,params) { bringAllVehicles(client, params); } },
	{ name: "resetveh",	level: 5, cost: 0, flags: ALLOW_ALL, 		arguments: "", 		function: function(client,params) { resetVehicles(client, params); } },
	//{ name: "test",		level: 5, cost: 0, flags: ALLOW_ON_FOOT, 	arguments: "", 		function: function(client,params) { geta(client, params); } },
	{ name: "acd",		level: 5, cost: 0, flags: ALLOW_ALL, 		arguments: "", 		function: function(client,params) { countdown(client,true); } },
	{ name: "setpass",	level: 5, cost: 0, flags: ALLOW_ALL, 		arguments: "", 		function: function(client,params) { setPassword(client, params) } },
	{ name: "setblip",	level: 5, cost: 0, flags: ALLOW_ALL, 		arguments: "", 		function: function(client,params) { setBlip(client, params) } },
	{ name: "attachblip",level: 5, cost: 0, flags: ALLOW_ALL, 		arguments: "i", 	function: function(client,params) { attachBlip(client, params) } },
	
	// Bank
	{ name: "deposit",	level: 0, cost: 0, flags: ALLOW_BANK, 		arguments: "i",		function: function(client,params) { Bank.deposit(client, params) } },
	{ name: "withdraw",	level: 0, cost: 0, flags: ALLOW_BANK, 		arguments: "i",		function: function(client,params) { Bank.withdraw(client, params) } }
]

function commandHelp(client,param) {
	let findCommand = param.toString().toLowerCase();
	let i = commands.findIndex( commands => commands.name == findCommand );

	if (typeof commands[i] != "undefined") {
		let command = commands[i];
		let flags = JSON.stringify(command_flags[command.flags]);
		let locale = Player.get(client).getLocale();
        let description = locale.getString(`command.description.${findCommand}`);  
...
addCommandHandler("listCommands", (command, params, client) => {
	for (let i = 0; i < commands.length; i++) {
		let desc = Locale.getString(`command.description.${commands[i].name}`);  
...
function geta(client, params) {
	...
	let targets = filterRadius(client, params[0], params[1]);
...
function filterRadius(client, type, radius) {
	...
	getAll(type).forEach(element => {
		let target = type == "clients" ? element.player : element;
...
function set(client, params) {
	...
	let target = index == "all" ? filterRadius(client, type, radius) : Number(index);
...
function attachBlip(client, params) {
	params = params.split(" ");
	let player = Player.get(client);
	let target = getClientFromParams(params[0]);
...
function printStats(client,params) {
	...
	let joins = playerDb.joins;
	let kills = playerDb.kills;
	let deaths = playerDb.deaths;
	let headshots = playerDb.headshots;
	let money = playerDb.cash;
	let bank = playerDb.bank;
	let mileage = playerDb.mileage;
	let online = playerDb.onlineTime;
	let convoys = playerDb.convoys;
	let dodo = playerDb.dodoFlightTime;
	let xp = playerDb.xp;
	let exp = XP.parseByXP(xp);
...
function printRawStats(client,params) {
	...
	if (player) {
		let rawStats = JSON.stringify(player.db);
...
function printAchievements(client,params) {
	...
	Achievement.getFilteredList().forEach(element => {
		...
		let groupCompletion = Achievement.getGroupCompletion(element,player.db[element]);
...
function checkCommandFlags(client, command) {
	...
	let i = commands.findIndex( commands => commands.name == command.toLowerCase() );

	if (typeof commands[i] != "undefined") {
		//if (typeof params == "undefined") params = "";
		let flags = command_flags[commands[i].flags];
		let player = client.player;
		let dojoId = client.getData("dojo");
		let inBank = client.getData("inBank");
		let locale = Player.get(client).getLocale();
...
addEventHandler("OnPlayerCommand", (event,client,command,params) => {
	...
	if (typeof commands[i] != "undefined") {
		let isCommandAllowed = checkCommandFlags(client, command);
		let locale = Player.get(client).getLocale();
